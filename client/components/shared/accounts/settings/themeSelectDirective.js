...
angular.module('mashPotatoes').directive('themeSelect', ['settings', function (settings) {
	return {
		restrict: 'E', // E = element, A = attribute, C = class, M = comment
		scope: { // @ = local scope (string), = = bi-directional binding, & = parent execution binding (function)

		},
		templateUrl: 'client/components/shared/accounts/settings/themeSelectView.ng.html',
