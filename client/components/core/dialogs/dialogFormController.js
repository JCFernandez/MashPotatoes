...
angular.module('mashPotatoes').controller('DialogFormController', ['$rootScope', '$scope', '$compile', '$mdDialog', 'data', '$log', function ($rootScope, $scope, $compile, $mdDialog, data, $log) {
